...
const SEGMENT_LABELS = {
  ...
  accountpurpose: { titleKey: "crumbAccountPurpose", breadcrumb: ["crumbIndividual", "crumbAccountPurpose"] },
  "account-purpose": { titleKey: "crumbAccountPurpose", breadcrumb: ["crumbIndividual", "crumbAccountPurpose"] },
  ...
  designation: { titleKey: "crumbDesignation", breadcrumb: ["crumbIndividual", "crumbDesignation"] },
  disability: { titleKey: "crumbDisability", breadcrumb: ["crumbIndividual", "crumbDisability"] },
  employment: { titleKey: "crumbEmployment", breadcrumb: ["crumbIndividual", "crumbEmployment"] },
  occupation: { titleKey: "crumbOccupation", breadcrumb: ["crumbIndividual", "crumbOccupation"] },
  qualification: { titleKey: "crumbQualification", breadcrumb: ["crumbIndividual", "crumbQualification"] },
  religion: { titleKey: "crumbReligion", breadcrumb: ["crumbIndividual", "crumbReligion"] },
  sourceoffund: { titleKey: "crumbSourceOfFund", breadcrumb: ["crumbIndividual", "crumbSourceOfFund"] },
  "source-of-fund": { titleKey: "crumbSourceOfFund", breadcrumb: ["crumbIndividual", "crumbSourceOfFund"] },
  maritalstatus: { titleKey: "crumbMaritalStatus", breadcrumb: ["crumbIndividual", "crumbMaritalStatus"] },
  visatype: { titleKey: "crumbVisaType", breadcrumb: ["crumbIndividual", "crumbVisaType"] },
  immigrationstatus: { titleKey: "crumbImmigrationStatus", breadcrumb: ["crumbIndividual", "crumbImmigrationStatus"] },
  addresstype: { titleKey: "crumbAddressType", breadcrumb: ["crumbIndividual", "crumbAddressType"] },
  relationshiptype: { titleKey: "crumbRelationshipType", breadcrumb: ["crumbIndividual", "crumbRelationshipType"] },
  ...
  indvtaxstatus: { titleKey: "crumbIndvTaxStatus", breadcrumb: ["crumbIndividual", "crumbIndvTaxStatus"] },
  indvtaxclassification: { titleKey: "crumbIndvTaxClassification", breadcrumb: ["crumbIndividual", "crumbIndvTaxClassification"] },
  indvpepstatus: { titleKey: "crumbIndvPepStatus", breadcrumb: ["crumbIndividual", "crumbIndvPepStatus"] },
  indvpepcategory: { titleKey: "crumbIndvPepCategory", breadcrumb: ["crumbIndividual", "crumbIndvPepCategory"] },
  ...
  taxstatus: { titleKey: "crumbIndvTaxStatus", breadcrumb: ["crumbIndividual", "crumbIndvTaxStatus"] },
  taxclassification: { titleKey: "crumbIndvTaxClassification", breadcrumb: ["crumbIndividual", "crumbIndvTaxClassification"] },
  pepstatus: { titleKey: "crumbIndvPepStatus", breadcrumb: ["crumbIndividual", "crumbIndvPepStatus"] },
  pepcategory: { titleKey: "crumbIndvPepCategory", breadcrumb: ["crumbIndividual", "crumbIndvPepCategory"] },
  ownershipsubtype: { titleKey: "crumbOwnershipSubType", breadcrumb: ["crumbMaster", "crumbOwnershipSubType"] },
  title: { titleKey: "crumbTitleMaster", breadcrumb: ["crumbIndividual", "crumbTitleMaster"] },
  kinship: { titleKey: "crumbKinship", breadcrumb: ["crumbIndividual", "crumbKinship"] },
  businessnature: { titleKey: "crumbBusinessNature", breadcrumb: ["crumbIndividual", "crumbBusinessNature"] },
  annualincomerange: { titleKey: "crumbAnnualIncomeRange", breadcrumb: ["crumbIndividual", "crumbAnnualIncomeRange"] },
  ...
  digitalproduct: { titleKey: "crumbDigitalProduct", breadcrumb: ["crumbDigitalProduct"] },

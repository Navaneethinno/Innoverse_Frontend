...
// DigitalProduct.jsx (the 9 existing standalone listing/Add/Edit
...
// imports the other (a DigitalProduct <-> AddDigitalProductWizard
...
export function DigitalProductFieldInput({ fieldKey: key, type, value, onChange, lookups = {}, disabled = false, disabledReason }) {
  ...
  // DigitalProduct.jsx) render a CheckboxPill directly for it

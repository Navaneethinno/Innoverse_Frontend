...
const CONFIGS = {
  acct_product: {
    ...
    // rather than just "Product" (see DigitalProduct.jsx's
...
// for others (see InstitutionCurrency.jsx / InstitutionChannel.jsx,
...
export function AcctConfigResource({ entity }) {
  ...
  // dialog, same pattern as InstitutionBranding.jsx — fetched only

...
export function InstitutionCard({ inst, index }) {
    ...
    >
      ...
      <div className="relative">
        <div className="flex items-start justify-between mb-4">
          <div
            className={cn(
              `w-11 h-11 rounded-xl bg-gradient-to-br ${grad} flex items-center justify-center text-white text-base font-black shadow-md`,
            )}
          >
